package javastory.budgetsh.stage2.budget.entity.budget;
...
import javastory.budgetsh.stage2.budget.entity.travel.Travel;
import javastory.budgetsh.stage2.budget.share.DatePair;
import javastory.budgetsh.stage2.budget.share.Entity;
import javastory.budgetsh.stage2.budget.share.IdName;
import javastory.budgetsh.stage2.budget.share.Socialian;
...
public class CashBook extends Entity {
	...
	public CashBook(Travel travel, double monthlyDue, double budgetGoal, DatePair term,String id) {
		// 
		super(id);
		this.travel = travel.getIdName();
		this.club = travel.getClub(); 
