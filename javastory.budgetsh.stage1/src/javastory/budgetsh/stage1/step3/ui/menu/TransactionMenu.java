...
import javastory.budgetsh.stage1.step3.ui.console.TransactionConsole;
...
public class TransactionMenu {
	...
	public void show(CashBook currentBook) {
		...
		while(true) {
			...
			//
			case 1:
				transactionConsole.register(currentBook);
				break;
			case 2:
				transactionConsole.find(currentBook);
				break;
			case 3:
				transactionConsole.findAll(currentBook);
				break;
			case 4:
				transactionConsole.modify(currentBook);
				break;
			case 5:
				transactionConsole.remove(currentBook);
				break;
			case 6:
