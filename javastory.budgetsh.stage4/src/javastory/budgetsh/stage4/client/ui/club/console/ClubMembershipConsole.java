...
import javastory.budgetsh.stage4.server.club.entity.club.RoleInClub;
...
import javastory.budgetsh.stage4.server.club.util.MemberDuplicationException;
...
public class ClubMembershipConsole {
	...
	public ClubMembershipConsole() {
		//
		ClubServiceLycler serviceFactory = ClubServiceLogicLycler.shareInstance();
